...
function UserCart() {
    ...
    useEffect(() => {
        ...
        script.async = true;
        script.onload = () => {
          // Razorpay script has loaded, initialize Razorpay object here
          const options = {
            key: 'rzp_test_aL4CWUYkpVuTp',
          ...
          // Continue with Razorpay initialization and usage
        };
